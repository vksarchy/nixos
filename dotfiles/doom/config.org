...
#+RESULTS:
: ((buffer-predicate . doom-buffer-frame-predicate) (right-divider-width . 1) (bottom-divider-width . 1) (alpha 94 . 96) (undecorated . t) (vertical-scroll-bars) (tool-bar-lines . 0) (menu-bar-lines . 0))
...
* Evil mode setup
This sets up tn an evil escape sequence. Not used anymore due to setting esc keys in firmware.
...
** Markdown Tables
#+begin_src emacs-lisp
;; === Beautiful Markdown tables (Google Sheets vibe) ===
(use-package! valign
  :hook (markdown-mode . valign-mode)
  :config
  (setq valign-fancy-bar t))   ; ← this gives the nice grid/border look

;; Bonus: powerful Org-style table editing inside .md files
