...
;;             (dolist (tag (split-string (match-string 1) "[,;]" t "[[:space:]]"))
;;               (push (string-trim tag) tags-list)))))
;;       (mapconcat 'identity
;;                  (completing-read-multiple "Tags: "
;;                    (sort (delete-dups tags-list) 'string<))
;;                  ", "))))
...
(map! :leader
      (:prefix ("C" . "commander")
       :desc "Commander Protocol capture" "c" (cmd! (org-capture nil "c"))))
        ...
        '(
          ...
          ;; ============================================
            ...
            :if-new (file+head "notes/%<%Y%m%d%H%M%S>.org"
                                "#+title: ${title}\n#+date: %U\n#+filetags: :%^{Tag|media|literature|fleeting|mindset|history|academic}:\n\n")
            :unnarrowed t)
          ...
          ("m" "Client/Property Profile" plain
           "* Overview\n\n%?\n\n* Details\n\n* History/Timeline\n\n* Current Status\n\n* Key Documents\n\n* Notes\n"
           :if-new (file+head "client/${title}.org"
                              "#+title: ${title}\n#+date: %U\n#+filetags: :profile:\n#+type: %^{Type|Property|Buyer|Seller|College|Vendor|Partner}\n#+business: %^{Business|Kappini|InLingua|Coworking}\n#+status: active\n\n")
           :unnarrowed t)
          
          ("d" "Design Quote (Simple)" plain
           "* Client Requirements\n\n%?\n\n* Scope of Work\n- [ ] \n\n* Changes/Modifications\n\n** Items & Estimates\n\n| Item/Service | Description | Qty | Unit Cost | Total Cost | Notes |\n|--------------|-------------|-----|-----------|------------|-------|\n|              |             |     |           |            |       |\n#+TBLFM: $5=$3*$4\n\n** Summary\n| Category | Amount |\n|----------|--------|\n| Subtotal |        |\n| GST 18%  |        |\n| Total    |        |\n\n* Budget Discussion\n\n* Timeline\n\n* Next Steps\n- [ ] \n"
           :if-new (file+head "design/${title}.org"
                              "#+title: ${title}\n#+date: %U\n#+filetags: :quote:design:\n#+business: Kappini\n\n")
           :unnarrowed t)

          ;; ("w" "Deep Design Quote" plain
          ;;  "* Project Overview\n:PROPERTIES:\n:CLIENT: %^{Client Name}\n:LOCATION: %^{Location}\n:PROPERTY_TYPE: %^{Type|Residential|Commercial|Mixed}\n:PROJECT_START: %^{Start Date|%<%Y-%m-%d>}\n:PROJECT_END: %^{Target Completion|%<%Y-%m-%d>}\n:BUDGET_RANGE: %^{Budget Range}\n:STATUS: Draft\n:END:\n\n%?\n\n* Client Requirements\n** Primary Goals\n- \n\n** Must-Haves\n- \n\n* Scope of Work\n- [ ] \n\n* Items & Cost Breakdown\n** Labor Estimates\n| Category | Worker Type | Days | Rate/Day | Subtotal | Notes |\n|----------+-------------+------+----------+----------+-------|\n|          |             |      |          |          |       |\n|----------+-------------+------+----------+----------+-------|\n| LABOR TOTAL |         |      |          |          |       |\n#+TBLFM: $5=$3*$4::@>$5=vsum(@2..@-1)\n\n** Materials Estimate\n| Item | Specification | Qty | Unit | Rate | Subtotal | Vendor |\n|------+---------------+-----+------+------+----------+--------|\n|      |               |     |      |      |          |        |\n|------+---------------+-----+------+------+----------+--------|\n| MATERIALS TOTAL |     |     |      |      |          |        |\n#+TBLFM: $6=$3*$5::@>$6=vsum(@2..@-1)\n\n** Project Summary\n| Category | Amount | % of Total |\n|----------+--------+------------|\n| Labor    |        |            |\n| Materials |       |            |\n|----------+--------+------------|\n| Subtotal |        |            |\n| GST 18%  |        |            |\n|----------+--------+------------|\n| *TOTAL*  |        |            |\n#+TBLFM: @>$2=vsum(@2..@-2)::$3=100*$2/@>$2;%.1f\n\n* Budget Analysis\n** Client Budget: ₹\n** Our Quote: ₹\n** Variance: \n\n* Timeline & Milestones\n| Phase | Task | Start Date | End Date | Status |\n|-------+------+------------+----------+--------|\n|       |      |            |          |        |\n\n* Vendor Contacts\n| Role | Name | Phone | Notes |\n|------+------+-------+-------|\n|      |      |       |       |\n\n* Payment Schedule\n| Milestone | % | Amount | Date | Status |\n|-----------+---+--------+------+--------|\n| Advance   |   |        |      |        |\n\n* Meeting Notes\n** Initial Consultation\n\n* Next Steps\n- [ ] \n"
          ;;  :if-new (file+head "quotes/${slug}.org"
          ;;                     "#+title: ${title}\n#+date: %U\n#+filetags: :quote:design:\n#+business: Kappini\n\n")
          ;;  :unnarrowed t)
          ...
          ("c" "inlingua College Meeting" plain
           "* College Information\n:PROPERTIES:\n:COLLEGE: %^{College Name}\n:DEPARTMENT: %^{Department}\n:CONTACT_PERSON: %^{Contact Person}\n:PHONE: %^{Phone}\n:EMAIL: %^{Email}\n:END:\n\n%?\n\n* Meeting Purpose\n%^{Purpose|Initial Contact|Follow-up|Course Discussion|Contract Negotiation}\n\n* Student Details\n** Expected Enrollment: %^{Number of Students}\n** Course Interest: %^{Course|German|French|Spanish|Japanese|IELTS|TOEFL}\n** Level: %^{Level|Beginner|Intermediate|Advanced}\n** Batch Start Date: %^{Start Date|%<%Y-%m-%d>}\n\n* Requirements from College\n- [ ] \n\n* Our Offer\n** Pricing\n| Tier | Students | Price/Student | Total |\n|------+----------+---------------+-------|\n|      |          |               |       |\n\n** Tentative Schedule\n| Day | Time | Duration | Room |\n|-----+------+----------+------|\n|     |      |          |      |\n\n* Discussion Points\n\n* Action Items\n- [ ] Send course brochure\n- [ ] Prepare quotation\n- [ ] Schedule next meeting\n\n* Next Steps\n- [ ] \n"
           :if-new (file+head "inlingua/${title}.org"
